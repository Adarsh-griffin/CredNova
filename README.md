...
| Resource | Link |
|---|---|
| 🖥️ Frontend Repository | [CredNova-fe](https://github.com/Adarsh-griffin/CredNova-fe) |
| ⚙️ Backend Repository | [CredNova-be](https://github.com/Adarsh-griffin/CredNova-be) |
